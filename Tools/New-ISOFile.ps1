...
.Example New-IsoFile "c:\tools","c:Downloads\utils" This command creates a .iso file in $env:temp folder (default location) 
    that contains c:\tools and c:\downloads\utils folders. 
...
.Example dir c:\WinPE | New-IsoFile -Path c:\temp\WinPE.iso 
...
.Notes NAME: New-IsoFile AUTHOR: Chris Wu LASTEDIT: 03/23/2016 14:46:50 

.Link http://thelowercasew.com/create-an-iso-file-with-powershell
#> 
